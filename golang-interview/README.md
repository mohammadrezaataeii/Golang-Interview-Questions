...
--- 
<a id="question8"></a>
## <h2 dir='rtl'>8-💡 defer، panic و recover در Go چه کاربردی دارند و چگونه با هم استفاده می‌شوند؟</h2> 

در Go، سه ویژگی **defer**، **panic** و **recover** به‌صورت مشترک برای مدیریت خطاها و اطمینان از عملکرد صحیح برنامه استفاده می‌شوند.

✅ **panic**: زمانی که یک خطای بحرانی رخ می‌دهد، اجرای برنامه را متوقف کرده و شروع به بازگرداندن پشته (stack) می‌کند.

✅ **defer**: تضمین می‌کند که یک قطعه کد مشخص، حتی در صورت وقوع خطا، اجرا شود (مثل آزادسازی منابع).

✅ **recover**: در داخل یک تابع deferred استفاده می‌شود تا **panic** را بازیابی کند و به برنامه اجازه دهد اجرای خود را ادامه دهد.
...
1. **panic** برنامه را متوقف می‌کند و شروع به بازگرداندن پشته می‌کند.
2. توابع تعریف‌شده با **defer** اجرا می‌شوند.
3. در صورت وجود **recover**، **panic** بازیابی شده و برنامه به اجرای خود ادامه می‌دهد.

🔒 **مزایا**:

- مدیریت خطاهای بحرانی
- اطمینان از تمیزکاری منابع (clean-up)

---

<a id="question9"></a>
## 9-💡نحوه مدیریت همزمانی در Maps در Go چگونه است و چه مشکلاتی ممکن است پیش بیاید؟
